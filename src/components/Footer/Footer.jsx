function Footer (){
    return (
        <footer className="bg-white">
            <div className="text-center text-sm lg:text-base container xl:max-w-7xl mx-auto px-4 py-16 lg:px-8 lg:py-32">
                <div className="space-y-10">
                    <nav className="space-x-4">
                        <a href="https://www.instagram.com/exploresrilanka_/" className="text-gray-400 hover:text-indigo-600">
                        ...
                        <a href="https://www.facebook.com/exploresrilankaofficial" className="text-gray-400 hover:text-indigo-600">
                        ...
                        <a href="https://twitter.com/ExploreLankaa" className="text-gray-400 hover:text-indigo-600">
                        ...
                        <a href="https://github.com/Explore-Srilanka" className="text-gray-400 hover:text-indigo-600">
                ...
                <hr className="my-10" />
                <div className="text-gray-600"><span className="font-medium">Traverser Inc</span> © {new Date().getFullYear()}
                </div>
            </div>
        </footer>
    )
